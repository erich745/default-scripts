...
function Get-maxPwdAge{
   $root = [ADSI]"LDAP://ServerName"
   $filter = "(&(objectcategory=domainDNS)(distinguishedName=DC=richmond,DC=company,DC=com))"
...
function send_email ($days_remaining, $email, $name ) 
{
 ...
 $SmtpClient.Host = "mail.smtp.com" 
 $mailmessage.from = "Helpdesk <HelpDesk@company.com>" 
...
contain a mix of THREE of the following FOUR properties:<br /><br />
    ...
    numbers (0-9)<br />
    symbols (!"£$%^&*)<br /><br />
If you have any questions, please email Helpdesk@company.com<br /><br />
...
$strFilter = "(&(objectCategory=User)(logonCount>=0)(!(userAccountControl:1.2.840.113556.1.4.803:=2))(!
